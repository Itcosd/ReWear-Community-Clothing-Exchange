...
urlpatterns = [
    ...
    path(
        "item-types/<int:pk>/",
        ItemTypeRetrieveUpdateDestroyView.as_view(),
    ...
    path(
        "conditions/", ConditionListCreateView.as_view(), name="condition-list-create"
    ),
    path(
        "conditions/<int:pk>/",
        ConditionRetrieveUpdateDestroyView.as_view(),
    ...
    path(
        "item-images/", ItemImageListCreateView.as_view(), name="itemimage-list-create"
    ),
    path(
        "item-images/<int:pk>/",
        ItemImageRetrieveDestroyView.as_view(),
        name="itemimage-detail",
    ),
]
